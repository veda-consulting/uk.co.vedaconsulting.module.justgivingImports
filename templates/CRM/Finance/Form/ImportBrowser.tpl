...
*}
<tr><td>Contact name</td><td><input name="contact_name" type="text" data-contact-search="name" size="50" /></td></tr>
...
//var contactIndividualUrl = "{crmURL p='civicrm/ajax/rest' q='entity=Contact&action=getquick&sequential=1&json=1&return[display_name]&return[sort_name]=1&return[email]=1&return[street_address]=1&return[city]=1&return[postal_code]=1&return[tags]=1' h=0}";
var contactIndividualUrl = "{crmURL p='civicrm/ajax/rest' q='rowCount=35&json=1&entity=Contact&action=getquick&sequential=1&params[contact_type]=Individual&s=cs&limit=25' h=0}";
//http://vedaconsulting.co.uk/civicrm/ajax/rest?rowCount=35&json=1&entity=Contact&action=getquick&sequential=1&params[contact_type]=Organization&s=cs&limit=25&timestamp=1351018925485&name=XXX
...
//                    "<td>" + rec.tags + "</td></tr>";
                ...
                msg += "<tr><td><input type=\"radio\" name=\"contact_id\" value=\"" + rec.id + "\"></td>" + 
                    "<td><a href=\"" + viewIndividual + rec.id + "\" target=\"individual\">" + rec.sort_name + "</a></td>" +
                    "<td>" +  rec.email + "</td></tr>";
            });
